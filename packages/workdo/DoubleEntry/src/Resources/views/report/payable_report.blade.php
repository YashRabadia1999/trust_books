...
@push('scripts')
    ...
    <script>
        ...
        function saveAsPDF() {
            ...
            if(id1 == '#vendor_balance') {
                var printContents = document.getElementById('vendor_balance').innerHTML;
            }
            else if(id1 == '#payable_summary') {
                var printContents = document.getElementById('payable_summary').innerHTML;
            }
            else if(id1 == '#payable_details') {
                var printContents = document.getElementById('payable_details').innerHTML;
            }             
        ...
        <div class="col-md-6">
            <ul class="nav nav-pills nav-fill cust-nav information-tab invoice-tab" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="payable-tab1" data-bs-toggle="pill" data-bs-target="#vendor_balance"
                        type="button">{{ __('Vendor Balance') }}</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="payable-tab2" data-bs-toggle="pill"
                        data-bs-target="#payable_summary" type="button">{{ __('Payable Summary') }}</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="payable-tab3" data-bs-toggle="pill"
                        data-bs-target="#payable_details" type="button">{{ __('Payable Details') }}</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="payable-tab4" data-bs-toggle="pill"
                        data-bs-target="#aging_summary" type="button">{{ __('Aging Summary') }}</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="payable-tab5" data-bs-toggle="pill"
