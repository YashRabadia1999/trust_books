            ...
            <div class="card">
                <div class="card-body">
                    <div class="invoice">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 invoice-title border-1 border-bottom  pb-3 mb-3">
                                    <h2 class="h3 mb-0">{{ __('Journal') }}</h2>
                                    <div
                                        class="d-flex invoice-wrp flex-wrap align-items-center gap-2">
                                        <div
