    ...
    <div class="row">
        <div class="col-12">
            <div class="card repeater" data-value='{!! json_encode($journalEntry->accounts) !!}'>
                <div class="item-section pt-4">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-md-12 d-flex align-items-center justify-content-end">
                            <div class="all-button-box">
                                <a href="#" data-repeater-create="" class="btn btn-primary me-4 d-inline-flex align-items-center gap-2" data-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 200px;">
                                        <div class="price-input">
                                            {{ Form::text('debit', '', ['class' => 'form-control debit', 'required' => 'required', 'placeholder' => __('Debit')]) }}
                                        </div>
                                    </td>
                                    <td style="min-width: 200px;">
                                        <div class="price-input">
                                            {{ Form::text('credit', '', ['class' => 'form-control credit', 'required' => 'required', 'placeholder' => __('Credit')]) }}
                                        </div>
                                    </td>
                                    <td style="min-width: 200px;">
                                        <div class="">
                                    ...
                                    <td class="text-end amount" style="min-width: 200px;">0.00</td>
                                    <td style="min-width: 200px;">
                ...
                <div class="card-footer text-end">
                    <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route('journal-entry.index')}}';" class="btn btn-secondary me-2">
