...
use Workdo\PettyCashManagement\Entities\PettyCashUtility;

class RoleTableSeederDatabaseSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        PettyCashUtility::defaultdata();
        PettyCashUtility::GivePermissionToRoles();
    }
}
