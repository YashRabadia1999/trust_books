{!! Form::open(['route' => 'reimbursement.store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) !!}
    ...
    <div class="modal-body">
        <div class="col-md-12">
            <div class="form-group">
                @if(in_array(Auth::user()->type, Auth::user()->not_emp_type))
                    ...
                    {{ Form::select('user_id', $user, null, ['class' => 'form-control', 'placeholder' => __('Select employee'), 'required']) }}
                @else
                    {{-- Employee View --}}
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::number('amount', null, ['class' => 'form-control', 'step' => '0.01', 'required' => true, 'placeholder' => __('Enter requested amount')]) }}
            </div>
        </div>
