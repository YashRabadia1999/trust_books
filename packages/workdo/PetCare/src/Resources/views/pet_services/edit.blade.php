{{ Form::model($petService, ['route' => ['pet.services.update', $petService->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate','enctype' => 'multipart/form-data']) }}
        ...
        <div class="form-group col-md-12" id="icons">
            ...
            <div class="form-group col-md-12">
                <input type="text" id="icon-input" name="service_icon" class="form-control"
                    placeholder="{{ __('Selected Icon') }}" readonly value="{{ old('service_icon', $petService->service_icon) }}">
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="form-group col-md-6 mb-0">
            {{ Form::label('service_image', __('Image'), ['class' => 'form-label']) }}
            <div class="choose-file">
                <label for="service_image" class="form-label">
                    <input type="file" name="service_image" id="service_image" class="form-control me-3" style="width: 365px;" onchange="document.getElementById('service_image_preview').src = window.URL.createObjectURL(this.files[0])">
                </label>
