{{ Form::open(array('route' => ['pet.adoption.request.payments.store'],'enctype' => 'multipart/form-data','method' => 'POST' , 'class'=>'needs-validation','novalidate')) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('amount',$getAdoptionRequestDueAmount, array('class' => 'form-control','required'=>'required','min'=>'0','step'=>'0.01','placeholder' => __('Enter Amount'),'max' => $getAdoptionRequestDueAmount)) }}
        </div>
        <div class="form-group col-md-6">
