...
{!! Form::open(['route' => 'pet.adoption.store','method' => 'POST','enctype' => 'multipart/form-data','class' => 'needs-validation','novalidate',]) !!}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('adoption_amount', 0.0, ['class' => 'form-control', 'required' => 'required', 'id' => 'totalAmount', 'step' => '0.01', 'placeholder' => __('Enter Adoption Amount')]) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="d-flex radio-check">
                <div class="form-check form-check-inline">
                    {{ Form::radio('gender', __('Male'), true, ['class' => 'form-check-input', 'id' => 'p_a_male']) }}
                    <label class="form-check-label" for="p_a_male">{{ __('Male') }}</label>
                </div>
                <div class="form-check form-check-inline">
                    {{ Form::radio('gender', __('Female'), false, ['class' => 'form-check-input', 'id' => 'p_a_male']) }}
                    <label class="form-check-label" for="p_a_male">{{ __('Female') }}</label>
                </div>
            </div>
        </div>        
        <div class="col-md-6">
        ...
        <div class="form-group col-md-6 mb-0">
            {{ Form::label('pet_image', __('Image'), ['class' => 'form-label']) }}<x-required></x-required>
            <div class="choose-file">
                <label for="pet_image" class="form-label">
                    <input type="file" name="pet_image" id="pet_image" class="form-control me-3" style="width: 365px;" onchange="document.getElementById('pet_image_preview').src = window.URL.createObjectURL(this.files[0])" required>
                </label>
