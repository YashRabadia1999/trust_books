{!! Form::model($petAdoptionRequest, ['route' => ['pet.adoption.request.update', $adoptionRequestId],'method' => 'PUT','class' => 'needs-validation','novalidate']) !!}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('adoption_amount', $petAdoptionAmount ?? null, ['class' => 'form-control', 'step' => '0.01', 'placeholder' => __('Enter amount'), 'readonly', 'disabled']) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
