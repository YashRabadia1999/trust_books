...
{{ Form::open(['route' => 'service.review.store', 'method' => 'POST', 'class' => 'space-y-4 needs-validation','novalidate']) }}
<div class="modal-body">
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('service_reviewer_name', __('Reviewer Name'), ['class' => 'form-label']) }}<x-required></x-required>
                {{ Form::text('service_reviewer_name', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Reviewer Name')]) }}
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::email('service_reviewer_email', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Email Address')]) }}
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::select('service_id', $services, null, ['class' => 'form-control service-select', 'placeholder' => __('Select Service'), 'id' => 'service_id_select','required' => 'required']) }}
                @if($services->isEmpty())
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('service_review', null, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('Tell us about your experience...'), 'required' => 'required']) }}
            </div>
        </div>
        ...
        <div class="col-md-6 form-group">
            ...
            {{ Form::hidden('service_rating', old('service_rating', 0), ['id' => 'service-rating-input']) }}
        </div>
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="form-check form-switch">
                ...
                {!! Form::checkbox('service_display_status', 1, old('service_display_status', 0), ['class' => 'form-check-input input-primary','id' => 'customCheckdef1',]) !!}
