...
{{ Form::open(['route' => 'petcare.review.store', 'method' => 'POST', 'class' => 'space-y-4 needs-validation','novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-6 form-group">
            ...
            {{ Form::hidden('rating', old('rating', 0), ['id' => 'rating-input']) }}
        </div>
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="form-check form-switch">
                ...
                {!! Form::checkbox('display_status', 1, old('display_status', 0), ['class' => 'form-check-input input-primary','id' => 'customCheckdef1',]) !!}
