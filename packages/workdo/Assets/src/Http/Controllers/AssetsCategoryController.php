...
class AssetsCategoryController extends Controller
{
    ...
    {
        return redirect()->route('assets-category.index')->with('error', __('Permission denied.'));
    ...
    public function destroy($id)
    {
        if(\Auth::user()->isAbleTo('assets category delete'))
        {
            ...
            return redirect()->route('assets-category.index')->with('success', __('The asset category has been deleted.'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
