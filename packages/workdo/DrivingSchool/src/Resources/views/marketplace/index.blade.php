...
@php
    $path = url('packages/workdo/DrivingSchool/src/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('DrivingSchool Management Simplified') }}</h2>
                    <p>{{ __("Effortlessly manage students, vehicles, classes, lessons, and invoices in one streamlined platform within Dash SaaS, enhancing efficiency and organization for your driving school operations.
                                                            ") }}
                    </p>
                </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('Personalized Lesson Planning') }}</h2>
                            </div>
                            <p>{{ __('Create customized lesson plans tailored to individual student needs with ease. Our platform provides tools for lesson scheduling, progress tracking, and feedback management, allowing instructors to deliver personalized instruction that maximizes student learning outcomes. With Dash SaaS, you can adapt lessons to individual learning styles, resulting in a more engaging and effective learning experience for your students.
                                                                                    ') }}
                            </p>
                        </div>
                    </div>
