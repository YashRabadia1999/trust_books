{{ Form::model($traking, ['route' => ['licence_traking.update', $traking->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'class'=>'needs-validation','novalidate']) }}
        ...
        <div class="form-group col-lg-6 col-md-4 col-sm-6">
            ...
            <div class="d-flex radio-check mt-2">
                <div class="col-md-6 custom-control custom-radio custom-control-inline">
                    <input type="radio" id="pass" value="pass" name="test_result" class="form-check-input" {{ $traking['test_result'] == 'pass' ? 'checked' : '' }} style="margin-right: 5px;">
                ...
                <div class="col-md-6 custom-control custom-radio ms-1 custom-control-inline">
                    <input type="radio" id="fail" value="fail" name="test_result" class="form-check-input" {{ $traking['test_result'] == 'fail' ? 'checked' : '' }} style="margin-right: 5px;">
