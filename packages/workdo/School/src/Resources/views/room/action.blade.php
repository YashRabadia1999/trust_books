@permission('school_room edit')
<div class="action-btn  me-2">
    <a class="mx-3 btn bg-info btn-sm  align-items-center"
        data-url="{{ route('school-room.edit', \Crypt::encrypt($room->id)) }}"
        data-ajax-popup="true" data-size="" data-bs-toggle="tooltip"
        title="" data-title="{{ __('Edit Room') }}"
...
@permission('school_room delete')
<div class="action-btn me-2">
    {{ Form::open(['route' => ['school-room.destroy', $room->id], 'class' => 'm-0']) }}
    @method('DELETE')
