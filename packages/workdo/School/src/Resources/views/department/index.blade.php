...
@section('page-action')
<div>
    @permission('school_department create')
        <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create New Department') }}" data-url="{{route('schooldepartment.create')}}" data-toggle="tooltip" title="{{ __('Create') }}">
...
<div class="row">
    ...
    @permission('school_department name edit')
    <div class="col-sm-9">
        <div class="card">
                ...
                <div class="d-flex align-items-center px-4">
                    <div class="action-btn bg-info">
                        <a  class="mx-3 btn btn-sm  align-items-center"
                            data-url="{{ route('schooldepartmentname.edit') }}"
                        ...
                        <tbody >
                            @forelse ($departments as $department)
                                <tr>
                                    ...
                                    <td class="Action">
                                        <span>
                                            @permission('school_department edit')
                                                <div class="action-btn me-2">
                                                    <a  class="mx-3 btn bg-info btn-sm  align-items-center"
                                                        data-url="{{ URL::to('schooldepartment/' . $department->id . '/edit') }}"
                                                        data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title=""
                                            ...
                                            @endpermission
                                            @permission('school_department delete')
                                            <div class="action-btn  me-2">
                                                {{Form::open(array('route'=>array('schooldepartment.destroy', $department->id),'class' => 'm-0'))}}
                                                @method('DELETE')
                                                    <a
