...
@php
    $path = url("/packages/workdo/School/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Dash SaaS introduces a robust School Management Module designed to simplify and enhance the administrative processes within educational institutions. This comprehensive module encompasses various facets, providing a seamless experience for administrators, teachers, students, and parents alike.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Efficient School Management with Dash SaaS Module')}}</h2>
                <p>{{__('Unlock efficiency in education with Dash SaaS. Manage admissions, enable personalized logins, oversee classes, and streamline user administration – all in one place!')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Admission Page: Effortless Student Record Management')}}</h2>
                        </div>
                        <p>{{__('The Admission Page serves as the gateway to student record management. Administrators can easily navigate through a list of admissions, each accompanied by a convenient button for converting admissions into student profiles. This streamlined feature ensures a smooth transition from admission to student record management, optimizing the overall administrative workflow.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('User Logins: Personalized Access for Every Role')}}</h2>
                        </div>
                        <p>{{__('Dash SaaS recognizes the diverse roles within an educational setting, introducing three distinct logins - Student Login, Teacher Login, and Parent Login. Each login type is tailored to provide a personalized experience, granting relevant access and information to students, teachers, and parents. This ensures that users can seamlessly engage with the platform based on their specific roles and responsibilities.')}}</p>
                    </div>
                </div>
            </div>
            <div class="row row-gap align-items-center padding-bottom">
