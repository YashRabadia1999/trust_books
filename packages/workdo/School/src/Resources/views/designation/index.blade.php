...
@section('page-action')
<div>
    @permission('school_designation create')
        <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create New Designation') }}" data-url="{{route('schooldesignation.create')}}" data-toggle="tooltip" title="{{ __('Create') }}">
...
<div class="row">
    ...
    @permission('school_designation name edit')
    <div class="col-sm-9">
        <div class="card">
                ...
                <div class="d-flex align-items-center px-4">
                    <div class="action-btn bg-info">
                        <a  class="mx-3 btn btn-sm  align-items-center"
                            data-url="{{ route('schooldesignationname.edit') }}"
                        ...
                        <tbody >
                            @forelse ($designations as $designation)
                                <tr>
                                    ...
                                    <td class="Action">
                                        <span>
                                            @permission('school_designation edit')
                                                <div class="action-btn  me-2">
                                                    <a  class="mx-3 btn  bg-info btn-sm  align-items-center"
                                                        data-url="{{ URL::to('schooldesignation/' . $designation->id . '/edit') }}"
                                                        data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title=""
                                            ...
                                            @endpermission
                                            @permission('school_designation delete')
                                            <div class="action-btn  me-2">
                                                {{Form::open(array('route'=>array('schooldesignation.destroy', $designation->id),'class' => 'm-0'))}}
                                                @method('DELETE')
                                                    <a
