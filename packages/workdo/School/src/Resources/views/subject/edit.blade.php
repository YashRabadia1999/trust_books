{{ Form::model($subject, array('route' => array('subject.update', $subject->id), 'method' => 'PUT','enctype'=>'multipart/form-data' , 'class' => 'needs-validation','novalidate')) }}
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-12">
            <div class="form-group">
                ...
                {!! Form::select('grade_name', $grade, isset($subject->grade_name) ? $subject->grade_name : '', [
                    'class' => 'form-control',
                    'required' => 'required',
        ...
        <div class="col-sm-6 col-12">
            <div class="form-group">
                ...
                {!! Form::select('class', $classRoom, $subject->class_id, [
                    'class' => 'form-control',
                    'required' => 'required',
        ...
        <div class="col-sm-6 col-12">
            <div class="form-group mb-0">
                ...
                {!! Form::select('teacher', $user, $subject->teacher, [
                    'class' => 'form-control',
                    'required' => 'required',
