{{ Form::open(['route' => 'school-alumini.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-12">
            <div class="form-group">
                <x-mobile divClass="form-label" type="number" name="contact" class="form-control" label="{{ __('Contact') }}" placeholder="{{ __('Enter Contact') }}" required></x-mobile>
            </div>
        </div>
    </div>
</div>
