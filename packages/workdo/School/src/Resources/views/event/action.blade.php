@permission('school_event edit')
<div class="action-btn  me-2">
    <a class="mx-3 btn  bg-info btn-sm  align-items-center"
        data-url="{{ route('school-event.edit', \Crypt::encrypt($event->id)) }}"
...
@permission('school_event delete')
<div class="action-btn  me-2">
    {{ Form::open(['route' => ['school-event.destroy', $event->id], 'class' => 'm-0']) }}
    @method('DELETE')
    <a class="mx-3 btn btn-sm bg-danger align-items-center bs-pass-para show_confirm"
        ...
        data-confirm-yes="delete-form-{{ $event->id }}"><i
