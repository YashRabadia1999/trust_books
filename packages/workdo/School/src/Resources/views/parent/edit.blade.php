...
@section('content')
    <div class="row">
        @if (!empty($parent))
            {{ Form::model($parent, ['route' => ['school-parent.update', $parent->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data','class' => 'needs-validation','novalidate']) }}
        @else
            {{ Form::open(['route' => ['school-parent.store'], 'method' => 'post' ,'class' => 'needs-validation','novalidate']) }}
        @endif
        <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('client', $client, isset($parent->client) ? $parent->client : null, [
                                'class' => 'form-control',
                                'required' => 'required',
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('student', $student, isset($parent->student) ? $parent->student : null, [
                                'class' => 'form-control',
                                'required' => 'required',
                                'placeholder' => __('Select Client Name'),
                            ]) !!}
                            ...
                            <div class="d-flex radio-check">
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="male"
                                        value="male"{{ isset($parent->gender) && $parent->gender == 'male' ? 'checked' : '' }}
                                        name="gender" class="form-check-input code" checked="checked">
                                    <label class="custom-control-label" for="male">{{ __('Male') }}</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="female" value="female"
                                        {{ isset($parent->gender) && $parent->gender == 'female' ? 'checked' : '' }}
                                        name="gender" class="form-check-input code">
                                    <label class="custom-control-label" for="female">{{ __('Female') }}</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="other" value="other"
                                        {{ isset($parent->gender) && $parent->gender == 'other' ? 'checked' : '' }}
                                        name="gender" class="form-check-input code">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="form-group">
                            {{ Form::label('parent_image', __('Photo'), ['class' => 'form-label']) }}
                            <div class="choose-file">
                                ...
                                width: -webkit-fill-available;">
                                    <input type="file" class="form-control" name="parent_image" id="parent_image"
                                        ...
                                        >
                                    <img id="blah" width="25%" class="mt-3"  src="{{ isset($parent->parent_image) ? get_file($parent->parent_image) : '' }}">
                                </label>
                            </div>
                        </div>
                    </div>
