...
@endphp
{{ Form::open(['url' => 'school-branch-setting', 'method' => 'post' , 'class' => 'needs-validation','novalidate']) }}
<div class="modal-body">
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                {{ Form::label('hrm_branch_name', !empty($company_settings['hrm_branch_name']) ? $company_settings['hrm_branch_name'] : 'Branch Name', ['class' => 'form-label']) }}<x-required></x-required>
