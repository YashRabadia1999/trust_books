    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">{{ __('Assignment Form') }}</h5>
            </div>
            <div class="card-body">
                {{ Form::open(['route' => 'school.assignment.store', 'method' => 'post', 'class'=>'needs-validation', 'novalidate']) }}
                <div class="row">
                    ...
                    <div class="col-12 mb-3" id="student-section" style="display:none;">
                        <label class="form-label fw-semibold">{{ __('Enter Student Details') }}</label>
...
(function(){
    ...
    $('form').on('submit', function(e){
        ...
        if(!$('#students_json').val()){
            e.preventDefault();
            alert('{{ __('Please add at least one student row or fill something to save.') }}');
        }
    });
