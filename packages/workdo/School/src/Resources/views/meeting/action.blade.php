@permission('school_meeting edit')
<div class="action-btn me-2">
    <a class="mx-3 btn bg-info btn-sm  align-items-center"
        data-url="{{ route('school-meeting.edit', \Crypt::encrypt($meeting->id)) }}"
...
@permission('school_meeting delete')
<div class="action-btn  me-2">
    {{ Form::open(['route' => ['school-meeting.destroy', $meeting->id], 'class' => 'm-0']) }}
    @method('DELETE')
