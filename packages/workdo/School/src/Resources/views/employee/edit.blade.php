...
@section('content')
    <div class="row">
        <div class="">
            <div class="">
                @if (!empty($employee))
                    {{ Form::model($employee, ['route' => ['schoolemployee.update', $employee->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data','class' => 'needs-validation','novalidate']) }}
                @else
                    {{ Form::open(['route' => ['schoolemployee.store'], 'method' => 'post', 'enctype' => 'multipart/form-data','class' => 'needs-validation','novalidate']) }}
                @endif
                @if (!empty($user->id))
                        ...
                        <div class="card em-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <x-mobile divClass='col-6' name="phone" label='Phone' placeholder='Enter employee phone' required></x-mobile>
                                    <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('employee_id', null, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
                                        </div>
                                        <div class="form-group col-md-6">
...
@push('scripts')
    <script type="text/javascript">
        ...
        function getDepartment(branch_id) {
            ...
            $.ajax({
                url: '{{ route('schoolemployee.getdepartment') }}',
                method: 'POST',
                data: data,
        ...
        function getDesignation(did) {
            $.ajax({
                url: '{{ route('schoolemployee.getdesignation') }}',
                type: 'POST',
                data: {
                    "department_id": did,
                    "_token": "{{ csrf_token() }}",
