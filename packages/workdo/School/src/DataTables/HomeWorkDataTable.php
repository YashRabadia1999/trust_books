...
class HomeWorkDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $dataTable = (new EloquentDataTable($query))
            ...
            if(\Laratrust::hasPermission('school_homework edit') ||
            \Laratrust::hasPermission('school_homework delete') || \Auth::user()->type == 'student') {
                $dataTable->addColumn('action', function (SchoolHomework $homework) {
                    return view('school::homework.action', compact('homework'));
                });
                $rowColumn[] = 'action';
            }
     ...
     */
    public function query(SchoolHomework $model): QueryBuilder
    {
        if (Auth::user()->type == 'student') {
            ...
            return $model->where('classroom', $classroom->id)->where('workspace', getActiveWorkSpace())->where('created_by', creatorId());
            ...
            return $model->whereIn('subject', $subject)->where('workspace', getActiveWorkSpace())->where('created_by', creatorId());
        } else {
    ...
    public function getColumns(): array
    {
        ...
        if (\Laratrust::hasPermission('school_homework edit') ||
        \Laratrust::hasPermission('school_homework delete') ||
