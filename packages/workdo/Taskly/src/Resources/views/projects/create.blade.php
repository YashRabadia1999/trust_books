...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-12">
             {{ Form::label('users_list', __('Staff'),['class'=>'form-label']) }}
        ...
        <div class="form-group col-md-12">
            {{ Form::label('clients_list', __('Clients'),['class'=>'form-label']) }}
            <select class="multi-select choices" id="clients_list" name="clients_list[]" multiple="multiple" data-placeholder="{{ __('Select Clients ...') }}">
