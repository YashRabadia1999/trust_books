...
use Workdo\Account\Http\Controllers\USSDCustomerController;
use Workdo\Account\Http\Controllers\USSDTransactionController;
...
Route::group(['middleware' => ['web', 'auth', 'verified', 'PlanModuleCheck:Account']], function () {
    ...
    // Route::get('dashboard/taskly',[ProjectController::class,'index'])->name('dashboard.taskly');
    ...
    // USSD Customer
    Route::get('/ussd-customer', [USSDCustomerController::class, 'view'])->name('account.customer.ussd.index');
    Route::get('/ussd/customers/data', [USSDCustomerController::class, 'data'])->name('account.ussd.customers.data');
    Route::get('/account/ussd-customer/{id}', [USSDCustomerController::class, 'show'])->name('account.ussd.customer.show');
   
   
    // USSD Transaction
    Route::get('ussd-transactions', [USSDTransactionController::class, 'view'])->name('account.ussd.transactions.page');
    Route::get('transactions/data', [USSDTransactionController::class, 'getTransactions'])->name('account.ussd.transactions.data');
