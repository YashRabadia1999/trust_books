    ...
    <script>
        ...
        $('#account_type').on('change', function() {
            ...
            if (optionsMap.hasOwnProperty(selectedOption)) {
                ...
                if (value !== null) {
                    $('[name="bill_type_radio"]').append('<option value="' + value + '">' + optionsMap[
                        selectedOption] + '</option>').trigger('change');
                }
            }
        });
    </script>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="row" id="vendor-box">
                                <div class="form-group col-md-6" id="account-box">
                                    <label
                                        class="reqire form-label">{{ __('Account Type') }}</label><x-required></x-required>
                                    <select
                                ...
                                <div class="form-group col-md-6">
                                    @if (module_is_active('Account'))
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('vendor_id', $vendors, $vendorId, ['class' => 'form-control ', 'id' => 'vendor', 'data-url' => route('bill.vendor'), 'placeholder' => 'Select vendor']) }}
