...
<div class="modal-body">
    ...
    <div class="row">
            ...
            <div class="form-group">
                ...
                <select name="payment_name" class="form-control" required="required">
                    <option value="Bank Transfer"
                        {{ $bankAccount->payment_name == 'Bank Transfer' ? 'selected' : '' }}>Bank Transfer</option>
                    @stack('bank_payments')
                </select>
            </div>
        </div>
        ...
        <x-mobile divClass="col-lg-6 col-md-6 col-sm-6 bank {{ $bankAccount->bank_type == 'wallet' ? 'd-none' : '' }}"
            name="contact_number" label="{{ __('Contact Number') }}" placeholder="{{ __('Enter Contact Number') }}"
            value="{{ !empty($bankAccount->contact_number) ? $bankAccount->contact_number : null }}"
            id="contact_number">
        </x-mobile>
        ...
        <div class="col-md-6 bank  {{ $bankAccount->bank_type == 'wallet' ? 'd-none' : '' }} ">
            <div class="form-group">
                ...
                {{ Form::text('bank_branch', null, ['class' => 'form-control', 'min' => '0', 'placeholder' => __('Enter Bank Branch'), 'id' => 'bank_branch']) }}
            </div>
        </div>
        <div class="col-md-6 bank  {{ $bankAccount->bank_type == 'wallet' ? 'd-none' : '' }} ">
            <div class="form-group">
