    ...
    public function handle(CompanyMenuEvent $event): void
    {
        ...
        // ]);
            ...
            $menu->add([
                ...
                'title' => __('Client'),
                'icon' => 'users', 
                'name' => 'customer', // unique identifier
                'parent' => null, 
                'order' => 3,
                'ignore_if' => [],
                'depend_on' => [],
            ...
            $menu->add([
                ...
                'icon' => 'user', // optional icon
                'name' => 'customer-list', // unique name
                'parent' => 'customer', // must match parent menu name
                'order' => 10,
                'ignore_if' => [],
                'depend_on' => [],
                'route' => 'customer.index', // actual route
                'module' => $module,
                'permission' => 'customer manage'
            ]);
        ...
        $menu->add([
            ...
            $menu->add([
                ...
                'ignore_if' => [],
                'depend_on' => [],
                'route' => 'account.customer.ussd.index',
                'module' => $module,
                'permission' => 'ussd_customer manage'
            ]);
        ...
        $menu->add([
            ...
            'ignore_if' => [],
            'depend_on' => [],
            'route' => 'account.ussd.transactions.page', 
            'module' => $module,
            'permission' => ''
        ]);
        $menu->add([
