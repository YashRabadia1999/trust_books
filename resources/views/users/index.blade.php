                        ...
                        @if (Auth::user()->type == 'super admin')
                            ...
                            <div class="mt-4">
                                <div class="row justify-content-between align-items-center">
                                    ...
                                    <div class="col-6 text-center">
                                        <span class="d-block font-bold mb-0">Encryption Key : </span>
                                    </div>
                                    <div class="col-6 text-center Id ">
                                        {{ $user->encryption_key ?? '' }}
                                    </div>
            ...
            @permission('user create')
                <div class="col-xxl-3 col-xl-4 col-md-6">
                    <a href="#" class="btn-addnew-project border-primary p-4" data-ajax-popup="true" data-size="md"
                        ...
                        <h6 class="mt-4 mb-2">{{ __('New Staff') }}</h6>
                        <p class="text-muted text-center mb-0">{{ __('Click here to Create New Staff') }}</p>
                    </a>
                </div>
            @endpermission
        @endif
