                    ...
                    <div class="">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="store_name" type="text"
                                class="form-control @error('store_name') is-invalid @enderror" name="workspace"
                                placeholder="{{ __('Enter WorkSpace Name') }}" value="{{ old('store_name') }}" required
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="mobile_no" type="text"
                                ...
                                placeholder="{{ __('Enter Mobile Number (ex. +91)') }}" value="{{ old('mobile_no') }}"
