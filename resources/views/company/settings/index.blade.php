...
<div class="card" id="system-settings">
    ...
    <div class="card-body p-3 pb-0">
        <div class="row">
            ...
            <div class="col-12">
                <div class="form-group">
                    {{ Form::label('sender_ids', __('Sender IDs'), ['class' => 'form-label']) }}
                    <small
                    ...
                    {{ Form::text('sender_ids', isset($settings['sender_ids']) ? $settings['sender_ids'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Sender IDs separated by commas'), 'id' => 'sender_ids']) }}
                </div>
            </div>
        </div>
    </div>
