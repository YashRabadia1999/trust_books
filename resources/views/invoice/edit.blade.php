                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="row" id="customer-box">
                                ...
                                <input type="hidden" name="account_type" value="{{ $invoice->account_type ?? '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{ Form::date('issue_date', null, ['class' => 'form-control ', 'required' => 'required', 'onchange' => 'Calculate()']) }}
        ...
        $(document).on('change', "[name='invoice_type_radio']", function() {
            ...
            const handleVehicleOrMachineInvoice = () => {
                ...
                var label = `
                    ...
                    {{ Form::number('service_charge', $invoice->category_id, ['class' => 'form-control service_charge', 'required' => 'required', 'id' => 'service_charge', 'placeholder' => 'Enter Service Charge', 'value' => '0']) }}
                `;
                $(".income_account_div").addClass('d-none');
                $(".account_id").removeAttr('required');
                $(".invoice_div").append(label);
