...
// Schedule birthday SMS to be sent daily at 9:00 AM
// Use --include-disabled to send to both active and inactive users
Schedule::command('birthday:send-sms --include-disabled')
    ->dailyAt('09:00')
