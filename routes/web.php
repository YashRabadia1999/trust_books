...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('sms-notification-settings-save', [SettingsController::class, 'smsNotificationStore'])->name('sms.notification.setting.store');
    ...
    Route::prefix('bulksms')->group(function () {
        Route::get('single-sms', [SingleSMSController::class, 'index'])->name('bulksms-single-sms.index');
        Route::get('single-sms/create', [SingleSMSController::class, 'create'])->name('bulksms-single-sms.create');
        Route::post('single-sms/store', [SingleSMSController::class, 'store'])->name('bulksms-single-sms.store');
        Route::delete('single-sms/{id}', [SingleSMSController::class, 'destroy'])->name('bulksms-single-sms.destroy');
        Route::get('single-sms/{id}/message', [SingleSMSController::class, 'message'])->name('bulksms-single-sms.message');

        // ✅ Add your new route here
        Route::post('single-sms/save-message', [SingleSMSController::class, 'storeMessageTemplate'])
            ->name('bulksms-single-sms.save-message');
    });
...
Route::get('/test-sms', function () {
    $result = SmsHelper::sendSms('233240123456', 'This is a test message from Laravel MNotify integration.', 'BizApp');
    dd($result);
});
